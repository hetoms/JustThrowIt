                        ...
                        <div className="header-box">
                            {this.props.userLoggedIn && this.props.isOnlineGameOwner ? (
                                <span className="back-btn">
                                    <Button onClick={this.forceFinish} color="success" className="small-button">Force finish
                                         all players</Button>
                                </span>
                            ) : null}
                            {isOnlineGame ? null : (<Link className="back-btn" to='/pickField'><Button
                        ...
                        <div>
                            {this.state.showOverview ? (
                                <div className="mobile-navigation-back-to-track">
                                    <Button className="small-button" color="success"
                                            onClick={() => this.hideOverview()}>Back to tracks</Button>
                                </div>
                            ) : (
                                <div className="mobile-navigation">
                                    <Button className="small-button" color="success" style={{marginLeft: 10}}
                                            onClick={() => this.showPrevTrack()}>Previous track</Button>
                                    <Button className="small-button" color="success"
                                            onClick={() => this.showOverview()}>Overview</Button>
                                    <Button className="small-button" color="success"
                                            onClick={() => this.showNextTrack()}>Next track</Button>
                                </div>
                            )}
                        </div>
                        {content}
